...
class StartPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        kezdo = tk.Button(self, text='Beginner',  
                            command=lambda : controller.show_frame(Page1),
                            font=('lucida handwriting', 35), height=5, width=250, bg="#bfd8d2", activebackground="#bad6d8", bd=1,fg='#DF744A',activeforeground='#DF744A')
        kezdo.pack() # pack it in

        kozepes = tk.Button(self, text='Intermediate', 
        ...
        halado = tk.Button(self, text='Advanced', 
...
class Page1(tk.Frame):
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)
        vissza = tk.Button(self, text='Back',font=('lucida handwriting', 12), bg="#bfd8d2", activebackground="#bad6d8", bd=1,fg='#DF744A',activeforeground='#DF744A',
                            command=lambda: controller.show_frame(StartPage))
        #vissza.pack(side="left")
        vissza.grid(row =0,column=0,sticky=W)
        label = tk.Label(self, text='Beginner', font=('lucida handwriting', 34),fg='#DF744A')
        label.grid(columnspan=15,ipadx=5)
        label_ures = tk.Label(self,text=" ",font=('lucida handwriting', 50))
        label_ures.grid(row=14,column=4)

        akkord_gomb = tk.Button(self, text='Chords', 
                            command=lambda : controller.show_frame(Page1_1),
                            font=('lucida handwriting', 34), height=9, width=28, bg="#bfd8d2", activebackground="#bad6d8", bd=1,fg='#DF744A',activeforeground='#DF744A')
        akkord_gomb.grid(row=30,column=0)
        pengetes_gomb = tk.Button(self, text='Strumming', 
...
class Page1_1(tk.Frame):
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)
        vissza = tk.Button(self, text='Back', bg="#bfd8d2", activebackground="#bad6d8", bd=1, font=('lucida handwriting', 12), fg='#DF744A',activeforeground='#DF744A', 
        ...
        vissza.grid(row =0,column=0,sticky=W)
        label = tk.Label(self, text='Beginner', font=('lucida handwriting', 34), fg='#bc5c36')
        label.grid(columnspan=15,ipadx=5)
        label = tk.Label(self, text='Chords', font=('lucida handwriting', 30), fg='#DF744A')
        label.grid(columnspan=15,ipadx=5)
        ...
        em_gomb = tk.Button(self, text='Em',
                            ...
                            font=('lucida handwriting', 34), height=4, width=14, bg="#bfd8d2", activebackground="#bad6d8", bd=1,fg='#DF744A',activeforeground='#DF744A')
...
class Page1_2(tk.Frame):
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)
        vissza = tk.Button(self, text='Back', bg="#bfd8d2", activebackground="#bad6d8", bd=1,fg='#DF744A',activeforeground='#DF744A', font=('lucida handwriting', 12),
                            command=lambda : controller.show_frame(Page1))
        vissza.grid(row =0,column=0,sticky=W)
        label = tk.Label(self, text='Beginner', font=('lucida handwriting', 34), fg='#bc5c36')
        label.grid(columnspan=15,ipadx=5)
        label = tk.Label(self, text='Strumming', font=('lucida handwriting', 30), fg="#DF744A")
        label.grid(columnspan=15,ipadx=5)
        label_ures = tk.Label(self,text=" ",font=('lucida handwriting', 25))
        label_ures.grid(row=14,column=4)

        akkordpeng_gomb = tk.Button(self, text='Chord strumming',
                                font=('lucida handwriting', 34),height=9, width=28, bg="#bfd8d2", activebackground="#bad6d8", bd=1,fg='#DF744A',activeforeground='#DF744A', 
                            command=lambda : controller.show_frame(Page1_21)
                            )
        akkordpeng_gomb.grid(row=30,column=0)
        pengfajt_gomb = tk.Button(self, text='Types of strumming',
                                font=('lucida handwriting', 34),height=9, width=28, bg="#bfd8d2", activebackground="#bad6d8", bd=1,fg='#DF744A',activeforeground='#DF744A',
...
class Page1_21(tk.Frame):
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text='Beginner', font=('lucida handwriting', 34), fg='#bc5c36')
        label.grid(columnspan=15,ipadx=5)
        label = tk.Label(self, text='Chord strumming', font=('lucida handwriting', 30), fg='#DF744A')
        label.grid(columnspan=15,ipadx=5)
        label_ures = tk.Label(self, font=('lucida handwriting', 25))
        label_ures.grid(row=3,column=4)
...
class Page1_22(tk.Frame):
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text='Beginner', font=('lucida handwriting', 34), fg='#bc5c36')
        label.grid(columnspan=15,ipadx=5)
        label = tk.Label(self, text='Types of strumming', font=('lucida handwriting', 30), fg='#DF744A')
        label.grid(columnspan=15,ipadx=5)
        label_ures = tk.Label(self, font=('lucida handwriting', 25))
        label_ures.grid(row=3,column=4)
        ...
        egy_gomb = tk.Button(self, text='1', 
                            ...
                            font=('lucida handwriting', 34), height=4, width=19, bg="#bfd8d2", activebackground="#bad6d8", bd=1,fg='#DF744A',activeforeground='#DF744A')
...
class Page2(tk.Frame):
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text='Intermediate', font=('lucida handwriting', 34), fg='#bc5c36')
        label.grid(columnspan=15,ipadx=5)
        label = tk.Label(self, text='Strummings', font=('lucida handwriting', 30), fg='#DF744A')
        label.grid(columnspan=15,ipadx=5)
        label_ures = tk.Label(self,text=" ",font=('lucida handwriting', 25))
        label_ures.grid(row=14,column=4)
        ...
        akkord_gomb = tk.Button(self, text='Chords',  
                            command=lambda : controller.show_frame(Page2_1),font=('lucida handwriting', 34), height=9, width=19, bg="#bfd8d2", activebackground="#bad6d8", bd=1,fg='#DF744A',activeforeground='#DF744A')
        akkord_gomb.grid(row=30,column=0)
        felbontas_gomb = tk.Button(self, text='Fingerpicking',  
                            command=lambda : controller.show_frame(Page2_2),font=('lucida handwriting', 34),height=9, width=19, bg="#bfd8d2", activebackground="#bad6d8", bd=1,fg='#DF744A',activeforeground='#DF744A')
        felbontas_gomb.grid(row=30,column=1)
        dalok_gomb = tk.Button(self, text='Songs',  
                            command=lambda : controller.show_frame(Page2_3),font=('lucida handwriting', 34),height=9, width=19, bg="#bfd8d2", activebackground="#bad6d8", bd=1,fg='#DF744A',activeforeground='#DF744A')
...
class Page2_1(tk.Frame):
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)
        vissza = tk.Button(self, text='Back', font=('lucida handwriting', 12), bg="#bfd8d2", activebackground="#bad6d8", bd=1,fg='#DF744A',activeforeground='#DF744A',
                            command=lambda : [variable.set("Choose!"), akk.configure(text=""), controller.show_frame(Page2), kuldKikapcs(szerverek[0]['ip'])])
        vissza.grid(row =0,column=0,sticky=W)

        label = tk.Label(self, text='Intermediate', font=('lucida handwriting', 34), fg='#bc5c36')
        label.grid(column=9,row=1,sticky="e", ipadx=20)
        label.place(x=900, y=50, anchor="center")
        label = tk.Label(self, text='Chords', font=('lucida handwriting', 30), anchor="center", fg='#DF744A')
        label.grid(column=9,row=2,sticky="e", ipadx=20)
        label.place(x=900, y=110, anchor="center")
        ...
        def callback(*args):            
            ...
            akk.place(x=900, y=400, anchor="center")
        ...
        menu.configure(font=('Lucida Handwriting', 15))
        w.configure(font=('Lucida Handwriting', 15))
...
class Page2_2(tk.Frame):
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text='Intermediate', font=('lucida handwriting', 34), fg='#bc5c36')
        label.grid(columnspan=15,ipadx=5)
        label = tk.Label(self, text='Fingerpicking', font=('lucida handwriting', 30), fg="#DF744A")
        label.grid(columnspan=15,ipadx=5)
        label_ures = tk.Label(self,text=" ",font=('lucida handwriting', 25))
        label_ures.grid(row=14,column=4)
...
class Page2_21(tk.Frame):
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)
        vissza = tk.Button(self, text='Back', font=('lucida handwriting', 12), bg="#bfd8d2", activebackground="#bad6d8", bd=1,fg='#DF744A',activeforeground='#DF744A',# likewise Page2
...
class Page2_3(tk.Frame):
    def __init__(self, parent, controller):
        ...
        label.place(x=900, y=50, anchor="center")
        label = tk.Label(self, text='Songs', font=('lucida handwriting', 30), fg='#DF744A')
        label.grid(columnspan=15,ipadx=5)
        label.place(x=900, y=110, anchor="center")
...
class Page3(tk.Frame):
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text='Advanced', font=('lucida handwriting', 34), fg='#DF744A')
        ...
        akkord_gomb = tk.Button(self, text='Chords',font=('lucida handwriting', 34), height=10, width=28, bg="#bfd8d2", activebackground="#bad6d8", bd=1,fg='#DF744A',activeforeground='#DF744A',
                              
                            command=lambda : controller.show_frame(Page3_1))
        akkord_gomb.grid(row=30,column=0)
        dalok_gomb = tk.Button(self, text='Songs', font=('lucida handwriting', 34), height=10, width=28, bg="#bfd8d2", activebackground="#bad6d8", bd=1,fg='#DF744A',activeforeground='#DF744A', 
...
class Page3_1(tk.Frame):
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)
        vissza = tk.Button(self, text='Back',font=('lucida handwriting', 12), bg="#bfd8d2", activebackground="#bad6d8", bd=1,fg='#DF744A',activeforeground='#DF744A', # likewise Page2
                            command=lambda : [variable.set("Choose!"), akk.configure(text=""), controller.show_frame(Page3), kuldKikapcs(szerverek[0]['ip'])])
        vissza.grid(row =0,column=0,sticky=W)

        label = tk.Label(self, text='Advanced', font=('lucida handwriting', 34), fg='#bc5c36')
        label.grid(column=5,row=1,sticky="e", ipadx=20)
        label.place(x=900, y=50, anchor="center")
        label = tk.Label(self, text='Chords', font=('lucida handwriting', 30), fg='#DF744A')
        label.grid(columnspan=15,ipadx=5)
...
class Page3_2(tk.Frame):
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)
        vissza = tk.Button(self, text='Back', font=('lucida handwriting', 12), bg="#bfd8d2", activebackground="#bad6d8", bd=1,fg='#DF744A',activeforeground='#DF744A',# likewise Page2
                            command=lambda : [variable.set("Choose!"), akk.configure(text=""), controller.show_frame(Page3)])
        vissza.grid(row =0,column=0,sticky=W)
